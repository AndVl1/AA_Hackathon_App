...
class FragmentPageAdapterTab(val childFragmentManager: FragmentManager) : FragmentPagerAdapter(
    ...
    override fun getItem(position: Int): FragmentCategoryListPage =
        when (position) {
            0 -> FragmentCategoryListPage(
                CategoryFant.Category1
            )
            1 -> FragmentCategoryListPage(
                CategoryFant.Category2
            )
            2 -> FragmentCategoryListPage(
                CategoryFant.Category3
            )
            3 -> FragmentCategoryListPage(
                CategoryFant.Category4
            )
            else -> FragmentCategoryListPage(
                CategoryFant.Category1
            )
        }
